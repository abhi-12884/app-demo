...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="padding-top:150px;">
       ...
       $DB_HOST= "database-1.cm2zi1jggnuq.us-east-2.rds.amazonaws.com";
       $DB_USER="vinayadmin";
       ...
       $DB_NAME="db_voting";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql= "INSERT INTO db_voting.tbl_users VALUES(null,'".$name."','".$email."','".$voterID."','".$selection."');";
				...
				else
				{
					...
					echo "<h3 class='text-info specialHead text-center'><strong> SORRY! You already Voted</strong></h3>";
					echo "<a href='logout.php' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> <strong> Logout</strong> </a>";
				}
